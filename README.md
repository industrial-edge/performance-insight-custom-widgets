...
| Click graphic to **download** JavaScript code<br>[![UseCase5](/docs/graphics/UseCase_5_MonthYearComparison.png "Click here to open JavaScript code")](/src/5_MonthYearComparison.js) <br>**Month/Year comparison**<br>to visualize consumptions<br>over time | Click graphic to **download** JavaScript code<br>[![UseCase6](/docs/graphics/ "Click here to open JavaScript code")](/src/4_KpiCalculation.js) <br>**yyy**<br>to yyy<br>yyy  |
